...
export class Home extends React.Component<RouteComponentProps<{}>, ContactState> {
    constructor() {
        super();
    ...
    OnSubmit(event) {
        //this.setState({ name: this.state.name, email: this.state.email }, () => alert(this.state.name + "," + this.state.email));
